...
mod tests {
    ...
    fn test_controller_multi_player() {
        ...
        let buttons1 = u16::from_be_bytes([
            bus.read_byte(0x1FC007C3),
            bus.read_byte(0x1FC007C4)
        ]);
        ...
        let buttons2 = u16::from_be_bytes([
            bus.read_byte(0x1FC007CB),
            bus.read_byte(0x1FC007CC)
        ]);
