...
mod tests {
    ...
    fn test_oam_dma_basic() {
        ...
        assert_eq!(sys.cpu.memory.ppu.read_oam_debug(0), 0x80, "OAM[0] should be 0x80");
        assert_eq!(sys.cpu.memory.ppu.read_oam_debug(1), 0x10, "OAM[1] should be 0x10");
        assert_eq!(sys.cpu.memory.ppu.read_oam_debug(2), 0x58, "OAM[2] should be 0x58");
        assert_eq!(sys.cpu.memory.ppu.read_oam_debug(3), 0x00, "OAM[3] should be 0x00");
    }
