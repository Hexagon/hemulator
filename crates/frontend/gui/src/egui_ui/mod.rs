...
pub use tabs::{
    ...
    DebugAction, GbTileData, GbaTileData, MegaDriveTileData, MountInfo, N64RdpData, N64ViData,
    NesTileData, PcBdaData, Ps1GpuData, Sg1000TileData, SmsTileData, SnesTileData, SystemTileData,
    Tab, TabAction,
};
