...
mod tests {
    ...
    fn test_sub_with_memory_operand() {
        ...
        loop {
            ...
            if iterations > 50 {
                ...
                panic!("Infinite loop! iterations={}, remaining={}", iterations, remaining);
            }
        }
        
        assert_eq!(cpu.memory.read(0x0200), 0, "Should count down to 0");
        assert_eq!(iterations, 21, "Should take 21 instructions (10 loops * 2 + 1 final)");
    }
    ...
    fn test_file_read_loop_pattern() {
        ...
        loop {
            ...
            if iterations < 20 || iterations > 95 {
                eprintln!("Iter {}: IP={:04X} Opcode={:02X} CX={} BX={:04X} AX={:04X} Flags={:04X}", 
            ...
            if iterations > 100 {
                ...
                eprintln!("Final state: CX={}, BX={:04X}, AX={:04X}, IP={:04X}", 
                         cpu.cx, cpu.bx, cpu.ax, cpu.ip);
                eprintln!("Flags: ZF={} SF={} CF={} OF={}", 
                         cpu.get_flag(0x0040), cpu.get_flag(0x0080), cpu.get_flag(0x0001), cpu.get_flag(0x0800));
    ...
    fn test_signed_comparison_loop_pattern() {
        ...
        loop {
            ...
            if iterations < 20 {
                eprintln!("Iter {}: IP={:04X} Opcode={:02X} CX={} BX={:04X} AX={:04X} Flags=ZF:{} SF:{}", 
                         iterations, cpu.ip, opcode, cpu.cx, cpu.bx, cpu.ax, 
                         cpu.get_flag(0x0040), cpu.get_flag(0x0080));
            }
            ...
            if iterations > 100 {
                panic!("Infinite loop detected! CX={}, BX={:04X}, AX={:04X}", 
                       cpu.cx, cpu.bx, cpu.ax);
            }
        }
    ...
    fn test_dec_and_loop_pattern() {
        ...
        loop {
            ...
            if iterations > 100 {
                panic!("Infinite loop in DEC pattern! CX={}, BX={}, iterations={}", 
    ...
    fn test_sub_and_compare_zero_pattern() {
        ...
        cpu.memory.write(0x0201, ((bytes_remaining >> 8) & 0xFF) as u8);
        ...
        loop {
            ...
            if iterations > 100 {
                ...
                panic!("Infinite loop in SUB pattern! CX={}, iterations={}, bytes_remaining={}", 
