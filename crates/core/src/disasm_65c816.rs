...
pub fn disassemble_65c816(memory: &[u8], address: u32) -> Option<DisassembledInstruction> {
    ...
    let len = match opcode {
        ...
        | 0xCA | 0xCB | 0xD8 | 0xDA | 0xDB | 0xE8 | 0xEA | 0xEB | 0xF8 | 0xFA | 0xFB => 1,

        // 3-byte instructions (absolute addressing, etc.)
        0x0C | 0x0D | 0x0E | 0x0F | 0x1C | 0x1D | 0x1E | 0x1F | 0x2C | 0x2D | 0x2E | 0x2F
        | 0x3C | 0x3D | 0x3E | 0x3F | 0x4C | 0x4D | 0x4E | 0x4F | 0x5C | 0x5D | 0x5E | 0x5F
        | 0x6C | 0x6D | 0x6E | 0x6F | 0x7C | 0x7D | 0x7E | 0x7F | 0x8C | 0x8D | 0x8E | 0x8F
        | 0x9C | 0x9D | 0x9E | 0x9F | 0xAC | 0xAD | 0xAE | 0xAF | 0xBC | 0xBD | 0xBE | 0xBF
        | 0xCC | 0xCD | 0xCE | 0xCF | 0xDC | 0xDD | 0xDE | 0xDF | 0xEC | 0xED | 0xEE | 0xEF
