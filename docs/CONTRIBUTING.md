...
- **Performance**: ~60fps (usable but not full speed)
- **Build time**: Fastest for clean builds (~2m50s)
- **Incremental**: Very fast
...
- **Performance**: ~90% of release performance (55-60fps)
